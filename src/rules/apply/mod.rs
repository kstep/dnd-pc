...
pub use pending::{
    ApplyInput, ApplyInputs, FeatureKey, InputsForFn, PICK_BACKGROUND, PICK_CLASS, PICK_SPECIES,
    PICK_SUBCLASS, PendingFeature, PendingInputs, RecomputePending, ReplacementForFn,
