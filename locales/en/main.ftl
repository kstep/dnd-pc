...
effect-expr-required = Expression
effect-dice = Dice
...
ref-spell-components = Components
ref-spell-comp-verbal = Verbal
ref-spell-comp-somatic = Somatic
ref-spell-comp-material = Material
ref-spell-comp-consumable = Material (consumed by the spell)
...
enchantment-no-passives = No effects
enchantment-no-actions = No actions
enchantment-action-name = Action name
enchantment-option-name = Mode name
assign-when = When
action-type = Turn cost
effects = Effects
effect-range = Range
effect-duration = Duration
enchantment-advanced = Advanced
effect-scope = Evaluate in context
effect-scope-hint = Name of the feature whose scope is used to evaluate the formula. Defaults to the parent item's scope.
effect-stackable = Stacks on reapply
range-caster = Self
range-touch = Touch
range-feet = Feet
...
choice-cost = Charge cost
choice-consumes = Item cost
...
# --- Item edit modal ---
item-edit = Edit item
item-tab-general = General
item-tab-effects = Effects
item-weight = Weight
item-price = Price
inventory-total-weight = Weight
requires-attunement = Requires attunement
attuned = Attuned
max-attunes = Max Attunes
inventory-attuned = Attuned
btn-add-damage = Add damage
