...
btn-apply-species = Применить расовые черты
...
panel-features = Особенности и черты
...
skill-perception = Внимательность
...
summary-resistances = Сопротивления
resistance-vulnerable = Уязвимость
resistance-resistant = Сопротивление
resistance-immune = Иммунитет
resistance-reduction = ПУ
