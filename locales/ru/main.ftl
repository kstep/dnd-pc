...
tools = Инструменты
tool = Инструмент
btn-add-tool = + Добавить инструмент
tool-count = Слоты инструментов
used = Исп.
total = Всего
max = Макс.
cost = Цена
...
session-skills = Навыки
session-tools = Инструменты
session-languages = Понятные языки
session-damage-modifiers = Сопротивления
sense = Чувство
session-senses = Чувства
senses = Чувства
sense-darkvision = Тёмное зрение
sense-blindsight = Слепое зрение
sense-tremorsense = Чувство вибрации
sense-truesight = Истинное зрение
...
effect-expr-required = Выражение
effect-dice = Кости
...
ref-spell-components = Компоненты
ref-spell-comp-verbal = Вербальный
ref-spell-comp-somatic = Соматический
ref-spell-comp-material = Материальный
ref-spell-comp-consumable = Материальный (расходуется)
...
enchantment-no-passives = Нет эффектов
enchantment-no-actions = Нет действий
enchantment-action-name = Название действия
enchantment-option-name = Название режима
assign-when = Когда
action-type = Расход хода
effects = Эффекты
effect-range = Дальность
effect-duration = Длительность
enchantment-advanced = Дополнительно
effect-scope = Вычислять в контексте
effect-scope-hint = Имя фичи, в скоупе которой вычисляется формула. По умолчанию — скоуп родительского предмета.
effect-stackable = Складывается при повторном применении
...
choice-cost = Расход зарядов
choice-consumes = Расход предметов
...
# --- Item edit modal ---
item-edit = Редактировать предмет
item-tab-general = Общее
item-tab-effects = Эффекты
item-weight = Вес
item-price = Цена
inventory-total-weight = Вес
requires-attunement = Требует настройки
attuned = Настроен
max-attunes = Макс. настроек
inventory-attuned = Настроено
btn-add-damage = Добавить урон
weapon-category = Категория
